...
int main()
{
  ...
  int c_arr[size] = {1,2,1,4,1,5,1,6,1,9};
   ...
   //int c_arr[size] = {9,8,7,6,5,4,3,2,1};
    ...
    for(int i = , u = 0; i < size; i+=2, u +=2){


    if(arr[i] - c_arr[i] > 0  && arr[i+1] - c_arr[i+1] ==0 ){
    ...
    else if(arr[i] - c_arr[i] < 0 && arr[i+1] - c_arr[i+1] ==0 ){

        cout << "primero segundo" << endl;
        cout << "i =" << i <<" u = " << u << " vez" << endl;
    ...
    cout << "i =" << i <<" u = " << u << " vez" << endl;
        ...
        cout << "estoy en el  segundo else if la " << "i =" << i <<" u = " << u << " vez" << endl;
        cout << arr[i] <<"arr, c_arr" <<  c_arr[i] << endl;
